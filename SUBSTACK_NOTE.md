...
Over the same window, a daily-sampled series — one snapshot of the deposit rate per day, which is how almost every dashboard and backtest samples a rate — reads above 8% on 89 of 366 days: 24.3% of the year. The actual rate, measured at every one of the 892,803 rate-update events that happened over that year, was above 8% for 2.34% of the time. A tenfold overstatement of how much time was spent at elevated rates.
